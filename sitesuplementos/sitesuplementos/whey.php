...
<html lang="en">
  ...
  <body class="p-3 m-0 border-0 bd-example">
    ...
    <ul class="nav nav-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Admin</font></font></a>
      </li>
    </ul>
    
    <!-- End Example Code -->
   
 <img src="imagens/whey_resized.png" alt="whey">

 <p class="info">Para que serve e quais são os benefícios do whey protein?<br> Além das proteínas e dos aminoácidos, o whey protein tem alta concentração de cálcio, trazendo benefícios para a saúde óssea do corpo. O consumo do suplemento pode ajudar no aumento da força e da massa muscular após a prática de atividades intensas </p>
