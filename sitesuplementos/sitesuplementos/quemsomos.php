...
<html lang="en">
  ...
  <body class="p-3 m-0 border-0 bd-example">
    ...
    <h1>Strong Suplementos</h1>

    <p class="info">Somos uma empresa focada em ensinar e educar sobre o uso de suplementos.<br>Online desde 2022 temos como o nosso grande objetivo ajudar a mostrar a real função dos suplementos e também desmetir falsas afirmações.</p>
